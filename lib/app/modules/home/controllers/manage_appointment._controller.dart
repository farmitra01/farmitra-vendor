...
class ManageAppointmentController extends GetxController
  ...
  final appointmentConsultationFee = TextEditingController();
  final diseaseConsultationFee = TextEditingController();
  final farmAdvisoryConsultationFee = TextEditingController();
