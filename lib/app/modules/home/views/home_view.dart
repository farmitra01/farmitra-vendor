...
class HomeView extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    int _getItemCount() {
      if (storeCategoryController.previousPageGridTitle == 'Rental' ||
          storeCategoryController.previousPageGridTitle == 'Drone') {
        return homeController.rentalGridItem.length;
      } else if (storeSelectedModuleController.previousSelectedValue ==
          'As a Retailer') {
    ...
    void _handleGridTap(int index, BuildContext context) {
      final category = storeCategoryController.previousPageGridTitle;
      final isRetailer =
                      ...
                      child: Column(
                        ...
                        children: [
                          SvgPicture.asset(
                            ...
                            height: 40, // Constrain image size for consistency
                            width: 40,
                          ),
                          const SizedBox(
                            height: 8,
