...
class SelectDocumentView extends GetView {
  ...
  final SelectDocumentController selectDocumentController =
      Get.put(SelectDocumentController());
  @override
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () {
                      Get.toNamed('/kyc_upload_document');
                    },
                    child: Container(
                      ...
                      child: Center(
                        child:
                            Text(selectDocumentController.documentsList[index]),
                      ),
                    ),
                  );
                },
